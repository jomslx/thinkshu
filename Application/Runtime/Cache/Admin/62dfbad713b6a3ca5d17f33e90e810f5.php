			...
			<div class="main-container-inner">
				...
				<div class="sidebar" id="sidebar">
					...
					<ul class="nav nav-list">
						...
						<li <?php if(in_array((ACTION_NAME), explode(',',"artadd,wdxs,hsz"))): ?>class="active open"<?php endif; ?> >
								...
								<div class="row">
								  ...
								  <div class="vspace-sm"></div>
									...
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="groupid"> 会员类别 </label>

										<div class="col-sm-9">
										  <select class="col-sm-3" id="groupid" name="groupid">
												<option value="2">普通会员</option>
												<option value="0">管理员</option>
												<option value="1">文章编辑</option>
											</select>
										</div>
									</div>
                                    
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="uname"> 会员名称 </label>

										<div class="col-sm-9">
										  <input type="text" id="uname" name="uname" placeholder="  请输入会员名称" class="col-xs-10 col-sm-5" />
										</div>
									</div>

                                    
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="pass"> 密码 </label>

										<div class="col-sm-9">
											<input type="text" id="pass" name="pass" placeholder="  请输入 密码 " class="col-xs-10 col-sm-5" />
										</div>
									</div>
                                    
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="pass_"> 重复密码 </label>

										<div class="col-sm-9">
										  <input type="text" id="pass_" name="pass_" placeholder="  重复密码 " class="col-xs-10 col-sm-5" />
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
										  <select id="sex" name="sex"  class="col-sm-2">
									...
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="intro"> 简介 </label>

										<div class="col-sm-9">
											<textarea class="form-control" id="intro" name="intro" placeholder="  用户简介" style="height: 120px;width: 502px;"></textarea>
										</div>
									</div>
